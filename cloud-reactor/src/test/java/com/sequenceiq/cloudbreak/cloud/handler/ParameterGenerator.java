...
public class ParameterGenerator {
    ...
    public CloudStack createCloudStack() {
        ...
        Subnet subnet = new Subnet("10.0.0.0/24", new HashMap<>());
        CloudAvailability cloudAvailability = new CloudAvailability(subnet, "az");
        groups.add(new Group(name, InstanceGroupType.CORE, Collections.singletonList(instance), ImmutableList.of(cloudAvailability), security, null,
