...
import com.sequenceiq.cloudbreak.security.StackServiceSecurityComponentTestOld.TestConfig;
...
public class StackServiceSecurityComponentTestOld extends SecurityComponentTestBase {

    private static final long ORGANIZATION_1 = 1L;
    ...
    @Test
    public void testFindStackByNameAndOrganizationId(){
        underTest.findStackByNameAndOrganizationId(USER_A, ORGANIZATION_1);
    }
