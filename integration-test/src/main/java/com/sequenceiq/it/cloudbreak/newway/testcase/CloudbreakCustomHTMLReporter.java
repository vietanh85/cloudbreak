...
public class CloudbreakCustomHTMLReporter extends HTMLReporter {

    private static final Logger LOGGER = LoggerFactory.getLogger(CloudbreakCustomHTMLReporter.class);
    ...
    private void generateResultFile(File outputDirectory, boolean onlyShowFailures,
        ...
        try {
            ...
            if (!onlyShowFailures || failuresExist) {
                ...
                generateFile(file, "integration-test." + RESULTS_FILE + TEMPLATE_EXTENSION, context);
            }
        } catch (Exception e) {
