...
public class SparkServer {
    ...
    @Value("${mock.server.port:#{T(java.util.concurrent.ThreadLocalRandom).current().nextInt(9400, 9900 + 1)}}")
    private int port;
    ...
    public void initSparkService() {
        ...
        LOGGER.info("SparkServer has been started on https://{}:{}", mockServerAddress, port);
    }
    ...
    public String getImageCatalogUrl() {
        return String.join("", "https://", mockServerAddress, ":", port + "", ITResponse.IMAGE_CATALOG);
    }
