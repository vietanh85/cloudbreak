...
public class ImageCatalogEntity extends AbstractCloudbreakEntity<ImageCatalogRequest, ImageCatalogResponse, ImageCatalogEntity> {
    ...
    public ImageCatalogEntity valid() {
        return withName(getNameCreator().getRandomNameForMock())
                .withUrl(getTestContext().getImgCatalog().getImgCatalogUrl());
    }
    ...
    public static ImageCatalogEntity putSetDefaultByName(TestContext testContext, ImageCatalogEntity entity, CloudbreakClient cloudbreakClient)
        ...
        entity.setResponse(
                cloudbreakClient.getCloudbreakClient()
                        .imageCatalogV3Endpoint().putSetDefaultByNameInWorkspace(cloudbreakClient.getWorkspaceId(), entity.getName()));
