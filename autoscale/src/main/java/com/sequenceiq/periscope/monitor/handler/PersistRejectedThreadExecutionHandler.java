...
@Component
public class PersistRejectedThreadExecutionHandler implements RejectedExecutionHandler {
    ...
    public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
        ...
        LOGGER.info("Thread is rejected: {} from {}", r, executor);
        ...
        if (realTask instanceof EvaluatorExecutor) {
            ...
            new AbortPolicy().rejectedExecution(r, executor);
        }
    }
