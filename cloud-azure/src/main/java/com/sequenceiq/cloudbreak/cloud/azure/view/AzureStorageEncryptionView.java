...
public class AzureStorageEncryptionView {
    ...
    public AzureStorageEncryptionView(Map<String, String> parameters) {
    ...
    public Boolean keyVaultRequired(Map<String, String> parameters) {
        if (Strings.isNullOrEmpty(parameters.get("keyVaultUrl"))) {
            return false;
        }
        return true;
    }

    public String keyVaultUrl(Map<String, String> parameters) {
        String keyVaultUrl = parameters.get("keyVaultUrl");
    ...
    public String keyVaultName(Map<String, String> parameters) {
    ...
    public String keyName(Map<String, String> parameters) {
        String keyVaultUrl = keyVaultUrl(parameters);
        if (Strings.isNullOrEmpty(keyVaultUrl)) {
            return "";
        } else {
    ...
    public String keyVersion(Map<String, String> parameters) {
        String keyVaultUrl = keyVaultUrl(parameters);
        if (Strings.isNullOrEmpty(keyVaultUrl)) {
            return "";
        } else {
    ...
    public Boolean encryptStorageAccount(Map<String, String> parameters) {
        String encryptStorage = parameters.get("encryptStorage");
